...
void gotoxy(int x,int y){ //Declaración de la función gotoxy de C
     HANDLE hcon;
...
//        if(l[posicionl].proceso[j].id != 0)
//        {
//            gotoxy(0,y1);
//            cout<<l[posicionl].proceso[j].id;
//            gotoxy(6,y1);
//            cout<<l[posicionl].proceso[j].tiempo;
//            gotoxy(11,y1);
//            cout<<l[posicionl].proceso[j].tt;
//            y1++;
//        }
//    }
//    y1=4;
...
//            for(int o = 0; o<=posicionl; o++)
//            {
//                for(int u = 0; u<4; u++)
//                {
//                    if(terminados[o].proceso[u].id != 0)
//                    {
//                        if(terminados[o].proceso[u].op == 1)
//                            operadorr = "+";
//                        else if(terminados[o].proceso[u].op == 2)
//                            operadorr = "-";
//                        else if(terminados[o].proceso[u].op == 3)
//                            operadorr = "*";
//                        else if(terminados[o].proceso[u].op == 4)
//                            operadorr = "/";
//                        else if(terminados[o].proceso[u].op == 5)
//                            operadorr = "R";
//                        else if(terminados[o].proceso[u].op == 6)
//                            operadorr = "^";

//                        gotoxy(40,y);
//                        cout<<terminados[o].proceso[u].id;
//                        gotoxy(46,y);
//                        cout<<terminados[o].proceso[u].op1<<operadorr<<terminados[o].proceso[u].op2;
//                        gotoxy(59,y);
//                        if(terminados[o].proceso[u].resultado == -3000)
//                        {
//                            cout<<"Error";
//                        }
//                        else
//                            cout<<terminados[o].proceso[u].resultado;
//                        y++;
//                    }
//                }
//                if(posicionl>0)
...
//            terminados[posicionl].proceso[posicionp] = l[posicionl].proceso[posicionp];
...
//                system("cls");
//                gotoxy(0,0);
//                cout<<"Numero de lotes pendientes: "<<lp;
//                gotoxy(0,2);
//                cout<<"Lote actual:";
//                gotoxy(0,3);
//                cout<<"ID";
